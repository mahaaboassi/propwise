...
const KPICards = () => {
    ...
    if (loading) {
        return (
        <div className="grid mobile-md:grid-cols-2 desktop-sm:grid-cols-4 gap-[12px]">
    ...
    return(<div className="grid mobile-md:grid-cols-2 desktop-sm:grid-cols-4 gap-[12px]">
